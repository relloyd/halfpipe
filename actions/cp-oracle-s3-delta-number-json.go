...
var jsonOracleS3DeltaNumber = `{
  "schemaVersion": 3,
  "description": "cp delta from Oracle to S3 using NUMBER field",
  "connections": {
    "source": {
      "type": "oracle",
