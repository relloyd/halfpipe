...
var jsonDsnSnowflakeDeltaNumber = `{
  "schemaVersion": 3,
  "description": "cp delta from DSN to Snowflake using NUMBER field",
  "connections": {
    "source": {
      "type": "${srcType}",
